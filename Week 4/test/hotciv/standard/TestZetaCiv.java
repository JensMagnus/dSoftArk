...
public class TestZetaCiv {
	...
	public void setUp() {
		...
		((GameImpl) game).createUnit(new Position(10,10), new UnitImpl(GameConstants.ARCHER, Player.RED, game.getUnitList()));
		((GameImpl) game).createUnit(new Position(10,11), new UnitImpl(GameConstants.ARCHER, Player.RED, game.getUnitList()));
		((GameImpl) game).createUnit(new Position(10,9), new UnitImpl(GameConstants.LEGION, Player.BLUE, game.getUnitList()));
